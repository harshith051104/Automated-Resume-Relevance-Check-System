...
with st.sidebar:
    ...
    with col1:
        ...
        st.markdown(f"""
        <div style="background: #1e293b; border: 1px solid #334155; border-radius: 8px; text-align: center; padding: 1rem; margin: 0.5rem 0;">
...
if page == "📋 Job Description Upload":
    ...
    with tab1:
        ...
        # Process button
        st.markdown("<br>", unsafe_allow_html=True)
        if st.button("🚀 Process & Save JD", type="primary", use_container_width=True):
